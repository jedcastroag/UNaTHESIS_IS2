...
User.create({ name: "Admin", surname: "Testercito", email: "admin@test.com", 
			password: "12345678", password_confirmation: "12345678", user_type_id: "admin" })
User.create({ name: "Student", surname: "Testercito", email: "student@test.com", 
			password: "12345678", password_confirmation: "12345678", user_type_id: "student" })
User.create({ name: "Tutor", surname: "Testercito", email: "tutor@test.com", 
			password: "12345678", password_confirmation: "12345678", user_type_id: "jury_tutor" })
